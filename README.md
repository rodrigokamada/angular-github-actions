...
Application example built with [Angular](https://angular.io/) 14 and hosted on [GitHub Pages](https://pages.github.com/) using [GitHub Actions](https://github.com/actions).
